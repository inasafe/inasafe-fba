...
CREATE TABLE IF NOT EXISTS public.hazard_event_buildings (
    ...
    CONSTRAINT flood_event_buildings_pkey PRIMARY KEY (id),
    CONSTRAINT flood_event_buildings_building_id_fkey FOREIGN KEY (building_id) REFERENCES public.osm_buildings(osm_id),
    CONSTRAINT flood_event_buildings_depth_class_id_fkey FOREIGN KEY (depth_class_id) REFERENCES public.hazard_class(id),
    CONSTRAINT flood_event_buildings_flood_event_id_fkey FOREIGN KEY (flood_event_id) REFERENCES public.hazard_event(id) ON DELETE CASCADE
);
